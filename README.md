...
**Protocol distribution:** 1.1.0-rc.3  
**AACP Core:** 1.0
...
Для подключения AACP к **любому существующему проекту** используйте единственный универсальный adoption prompt ниже. Его можно целиком передать Cursor, ChatGPT Project или другому AACP-compatible agent.

**Важно:** это единственный canonical project-adoption prompt. Отдельного project-adoption prompt-файла больше нет. Не создавайте и не поддерживайте альтернативные версии этого prompt в проектах или документации.

## Universal Project Adoption Prompt
...
- **Core** — нормативные семантики AACP.
- **Transports** — способы доставки AACP messages.
- **Conformance** — требования и проверяемые свойства.
- **Adoption** — процедура подключения и миграции.
- **Runtime** — обязательное поведение агента после adoption.
- **Recovery** — восстановление GitHub ordered streams.
...
The current repository version is **1.1.0-rc.3**. AACP Core remains **1.0**.

See [CHANGELOG.md](CHANGELOG.md) for release history.

## Статус

AACP Core 1.0 — stable baseline specification. The current repository state is **1.1.0-rc.3**; the final 1.1.0 distribution is not declared until the release tag and GitHub Release are created and verified.
